...
class OrderHistory {
  ...
  OrderHistory.fromJson(json) {
    ...
    subscriber_id = json['subscriber_id'] == null
        ? 0
        : int.parse(json['subscriber_id'].toString());
    is_paid =
        json['is_paid'] == null ? 0 : int.parse(json['is_paid'].toString());
    discount_id = json['discount_id'] == null
        ? 0
        : int.parse(json['discount_id'].toString());
    status = json['status'] == null ? 0 : int.parse(json['status'].toString());

    //double
    selling_total = json['selling_total'] == null
        ? 0
        : double.parse(json['selling_total'].toString());
    ...
    //list
    orderItems = json['order_list'] == null
        ? []
        : (json['order_list'] as List)
